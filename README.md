...
* https://bbycroft.net/llm - great interactive tutorial (I've followed it repeatedly), 1hr+
...
You're comfy with `pytorch` and you know enough of the Transformer architecture.
