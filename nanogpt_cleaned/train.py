...
# IAN lifted from config/train_shakespeare_char.py
...
# if wandb_log == True then at cmd line `export WANDB_API_KEY=wandb_v1_...`
...
#data_dir = os.path.join('data', dataset) # IAN removed
data_dir = dataset # IAN simplified
def get_batch(split):
